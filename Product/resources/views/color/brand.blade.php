    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <a href="{{ route('brand.update', $brand->id) }}"> <button type="button"
                            class="btn btn-primary mx-2">Update</button></a>
                    <a href="{{ route('brand.delete', $brand->id) }}"> <button type="button" class="btn btn-danger"
                            onclick="return confirm('Delete this brand?')">Delete</button></a>
                </td>
            </tr>
